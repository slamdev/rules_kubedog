...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@slamdev_rules_kubedog//kubedog:toolchain_type"]
    return [
        toolchain_info,
        toolchain_info.default,
        toolchain_info.kubedoginfo,
...
# By default all these toolchains are registered by the kubedog_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:kubedog_toolchain",
    toolchain_type = "@slamdev_rules_kubedog//kubedog:toolchain_type",
)
""".format(
            platform = platform,
