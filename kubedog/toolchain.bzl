...
def _kubedog_toolchain_impl(ctx):
    ...
    # Make the $(KUBEDOG_BIN) variable available in places like genrules.
...
kubedog_toolchain = rule(
    implementation = _kubedog_toolchain_impl,
    attrs = {
    ...
    doc = """Defines a kubedog compiler/runtime toolchain.
